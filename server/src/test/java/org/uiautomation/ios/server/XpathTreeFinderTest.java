...
public class XpathTreeFinderTest {
  ...
  private JSONTreeParser parser;

  @BeforeClass
  public void setup() throws JSONException {
    tree = new JSONObject(uiCatalog1).getJSONObject("tree");
    parser = new JSONTreeParser(tree);
  }
  ...
  private Object[][] xpathAndResult() {
    return new Object[][] {
        ...
        { "//*[contains(@name,'Use of UISearchBar') and contains(@value,'Use of UISearchBar')]",expected(18, UIAStaticText.class) }
       };
  }
