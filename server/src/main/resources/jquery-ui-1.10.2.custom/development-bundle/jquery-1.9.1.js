    ...
    jQuery.extend({
                      ...
                      attr: function (elem, name, value) {
                          ...
                          if (value !== undefined) {
                              ...
                              } else if (hooks && notxml && "set" in hooks && (ret =
                                                                               hooks.set(elem,
                                                                                         value,
                                                                                         name))
                                  !== undefined) {
                          ...
                          } else if (hooks && notxml && "get" in hooks && (ret =
                                                                           hooks.get(elem, name))
                              !== null) {
                              return ret;
        ...
        add: function (elem, types, handler, data, selector) {
            ...
            if (!(eventHandle = elemData.handle)) {
                eventHandle = elemData.handle = function (e) {
                    ...
                    return typeof jQuery !== core_strundefined && (!e || jQuery.event.triggered
                        !== e.type) ?
        ...
        trigger: function (event, data, elem, onlyHandlers) {
            ...
            if (!onlyHandlers && !event.isDefaultPrevented()) {
                ...
                if ((!special._default || special._default.apply(elem.ownerDocument, data)
                    === false) && !(type === "click" && jQuery.nodeName(elem, "a"))
                         ...
                         domManip: function (args, table, callback) {
                             ...
                             if (isFunction || !( l <= 1 || typeof value !== "string"
                                 ...
                                 return this.each(function (index) {
                                     ...
                                     if (isFunction) {
                                         args[0] =
                                         value.call(this, index, table ? self.html() : undefined);
                                     }
                         ...
                         css: function (name, value) {
                             return jQuery.access(this, function (elem, name, value) {
                                 ...
                                 if (jQuery.isArray(name)) {
                                     ...
                                     for (; i < len; i++) {
                                         map[ name[ i ] ] =
                                         jQuery.css(elem, name[ i ], false, styles);
                                     }
    ...
    jQuery.extend({
                      ...
                      ajax: function (url, options) {
                          ...
                          if (!s.hasContent) {
                              ...
                              if (s.data) {
                                  cacheURL =
                                  ( s.url += ( ajax_rquery.test(cacheURL) ? "&" : "?" ) + s.data );
