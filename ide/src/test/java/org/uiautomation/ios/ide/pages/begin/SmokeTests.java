...
public class SmokeTests {
  ...
  public void setup() throws Exception {
    IOSServer.main(new String[] {"-port",driver_port+"","-aut","/Users/freynaud/build/eBay2.2.2rc1.app","-aut" , "/Users/freynaud/build/eBayiPad.app"});
  ...
  public void smokeTest() {
    RemoteUIADriver driver =
        new RemoteUIADriver("http://localhost:"+driver_port+"/wd/hub", IOSCapabilities.ipad("eBay"));
